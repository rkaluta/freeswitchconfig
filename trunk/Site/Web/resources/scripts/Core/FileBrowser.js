...
Org.Reddragonit.FreeSwitchConfig.Site.Models.AudioFileEntry.View = Backbone.View.extend({
    tagName: "span",
...
Org.Reddragonit.FreeSwitchConfig.Site.Models.AudioFileEntry.CollectionView = Backbone.View.extend({
    tagName: "div",
